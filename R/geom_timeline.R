#' Plot Timeline
#'
#' @description This function plots a timeline of the earthquates that
#'   occurred in the selected country for the selected timeframe.
#'
...
#'
#' @return This function returns a timeline plot of earthquakes for 
#'   the selected country for the selected time frame
#' @export
#'
#' @examples
...
GeomTimeline <- ggplot2::ggproto("GeomTimeline",
                                 ...
                                 setup_data = function(data, params){
                                   ## Get data points between xmin and xmax
                                   data <- data %>%
